									...
									<tbody>
											<c:forEach items="${ListCP}" var="o">
												<tr>
													...
													<td class="align-middle"><a href="deletecookie?pid=${o.id}" class="text-dark">
							...
							<div class="p-4">
								<ul class="list-unstyled mb-4">
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
										class="text-muted">Tổng tiền hàng</strong><strong> ${Tong }
											$</strong></li>
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
										class="text-muted">VAT</strong><strong>10 $</strong></li>
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
										class="text-muted">Tổng thanh toán</strong>
										<h5 class="font-weight-bold"> ${TongTien } $</h5></li>
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
										class="text-muted"> ${TrangThai}</strong><strong></strong></li>
								</ul>
								<a href="buy" class="btn btn-dark rounded-pill py-2 btn-block"> ${Mess} </a>
							</div>
						</div>
					</div>
